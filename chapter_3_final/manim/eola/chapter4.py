...
class OpeningQuote(Scene):
    def construct(self):
        words = TextMobject([
            ...
            u"\\textarmenian{մատրիցներով}",
            u"\\textarmenian{կատարվող ապացույցները 50%-ով կկրճատվեն, եթե }",
            u"\\textarmenian{մատրիցները դեն նետենք:}"], 
        )
...
class RecapOver(TeacherStudentsScene):
    def construct(self):
        self.setup()
        self.teacher_says(TextMobject(u"\\textarmenian{Ամփոփումն ավարտեցինք}"))
